...
const cmd_func_map_t cmd_func_map_list[] = {\
	{"open", "file", open_file, "open file   open password file, e.g. open file temp.xml"},
...
char usage[] =
"Usage: lbmpwdgen\n"
"  After the prompt, 'pg>', enter one of the following subcommands:\n"
"    open file   open password file, e.g. open file temp.xml.\n"
"    close       close password file, e.g. close.\n"
"    add user    add a user with its name, password and role,"
"                e.g. add user userAbc pass1234 admin.\n"
"    del user    delete the user entry in the password file,"
"                e.g. del user userAbc.\n"
"    del urole   delete the role from the user's role list,"
"                e.g. del urole user admin.\n"
"    add role    add a role with its permitted action,"
"                e.g. add role admin MSG_LIST.\n"
