...
"application sends unicast immediate command messages to an umestore publishing daemon."
;

char usage[] =
"Usage: umedcmd -T target_string -c config_file [command_string]\n"
"Available options:\n"
